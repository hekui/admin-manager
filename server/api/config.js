...
const
  ...
  javaHost = process.env.javaHost || 'http://japi.test1.fangguancha.com', // 测试环境
  ...
  // passportHost = process.env.passportHost || 'http://192.168.10.223:8090', // 登陆(开发)
  passportHost = process.env.passportHost || 'http://uiap.test1.maifangma.com', // 登陆
